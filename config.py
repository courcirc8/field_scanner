...
#CENTER_FREQUENCY = 1*915e6  # Center frequency in Hz (default: 400 MHz)

EQUIVALENT_BW = 10e6      # Equivalent bandwidth in Hz (default: 50 MHz)
RX_GAIN = 76              # Receiver gain in dB 76dB fr SIMO noise
#RX_GAIN = 30              # Receiver gain in dB 20dB for Tx HA3 sniff
...
DEFAULT_Z = 97.3  # Default Z height in mm for printer positioning
...
OUTPUT_FILE = "scan_v1a_400MHz_Rx_small.json"  # Default output file name
